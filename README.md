...
Deep teal / charcoal / white. No AI or “powered by” marks on the public site. Phone is **Call coming soon**. Email is a labeled placeholder until a real inbox exists. Stripe keys live only in `.env.example` stubs.
